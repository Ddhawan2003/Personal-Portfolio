          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <div className="social-icon">
                <a href="https://linkedin.com/in/dhruvvdhawan"><img src={navIcon1} alt="" /></a>
                <a href="https://github.com/Ddhawan2003"><img src={navIcon2} alt="" /></a>
                <a href="https://www.instagram.com/ddhawan_2308_/"><img src={navIcon3} alt="" /></a>
              </div>
              <HashLink to='#connect'>
